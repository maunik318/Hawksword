...
public final class CameraManager {
	...
	public void turnOnTourch(boolean newValue){
		configManager.setTorch(camera, newValue);
	}
	public void changeFocusMode(String mode) {
		configManager.setFocus(camera, mode);
	}
